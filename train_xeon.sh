...
/glob/development-tools/versions/oneapi/2022.1.1/oneapi/intelpython/latest/envs/pytorch-1.8.0/bin/python dcgan.py --log_dir=logs/ --models_dir=saved_models/ --images_dir=images_fedavg/ --n_epochs=10 --batch_size1=64 --batch_size2=64 --sample_interval=200 --noise_multiplier=1e-6
