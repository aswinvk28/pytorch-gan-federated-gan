...
/glob/development-tools/versions/oneapi/2022.1.1/oneapi/intelpython/latest/envs/pytorch-1.8.0/bin/python dcgan.py --log_dir=logs3/ --models_dir=saved_models3/ --images_dir=images_fedavg3/ --n_epochs=1 --batch_size1=64 --batch_size2=64 --sample_interval=200 --noise_multiplier=0.99
